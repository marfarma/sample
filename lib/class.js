// JavaScript Inheritance -- Super Lightweight, powerful, 
// elegant Pseudoclassical inheritence for js
// linted version of: https://github.com/aglemann/js-oo
...
(function(Class){
    ...
    inherits = function(parent, protoProps, classProps) {
        ...
        if (classProps) { extend(child, classProps); }
